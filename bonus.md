...
Проверка кода. Если pay - 1700, то результат:
```
...
```
17.0 - верное начисление бонусных рублей.

Если pay - 900, то резулитат следущий:
...
Результат 0.0, это верный результат, при данных условиях.
